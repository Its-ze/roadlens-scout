...
`RoadLensESP32` from the Android app. Firmware `0.1.14` keeps Wi-Fi monitor mode
...
Firmware `0.1.14` supports in-app ESP32 firmware updates after the board has been

...
Firmware `0.1.14` starts in BLE-first mode: it advertises `RoadLensESP32`
...
Firmware `0.1.14` scans 2.4 GHz channels 1-11, uses the public Flock-style
...
Firmware `0.1.14` also supports BLE-orchestrated OTA updates. The app sends Wi-Fi
...
```json
{"type":"status","device":"RoadLensESP32","reason":"heartbeat","uptime_ms":123456,"channel":6,"detections":3,"signature_count":46,"ble_connected":true,"sniffer_active":true,"frames_seen":1800,"mgmt_frames":700,"data_frames":1100,"wildcard_probes":8,"candidate_frames":3,"queue_drops":0,"firmware_version":"0.1.14","chip_family":"ESP32","ota_supported":true,"ota_in_progress":false,"ota_version":"","signature_version":"2026.06.28.003ddaa1","signature_source":"synced","signature_sync_supported":true}
```

OTA status example:

```json
{"type":"ota","state":"download","detail":"Downloading firmware","progress":50,"version":"0.1.14","chip_family":"ESP32"}
```
